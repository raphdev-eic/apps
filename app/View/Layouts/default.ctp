...
<html lang="en">
  ...
  <section id="container" class="">
            ...
            <ul class="nav top-menu">
              ...
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu extended tasks-bar">
                      ...
                      <li>
                          <p class="green">Vous avez 0 nouveau badges</p>
                      </li>
                      <!--<li>
                          <a href="#">
                              <div class="task-info">
                      ...
                      <li class="external">
                          <a href="#">Afficher tous vos badges obtenus</a>
                      </li>
                  </ul>
              </li>
              <!-- settings end -->
              ...
              <li id="header_inbox_bar" class="dropdown">
                  ...
                  <ul class="dropdown-menu extended inbox">
                      ...
                      <li>
                          <p class="red">You have 0 nauveau messages</p>
                      </li>
                      <!--<li>
                          <a href="#">
                      ...
                      <li>
                          <a href="#">Afficher tous vos messages</a>
                      </li>
                  </ul>
              </li>
              <!-- inbox dropdown end -->
              ...
              <li id="header_notification_bar" class="dropdown">
                  ...
                  <ul class="dropdown-menu extended notification">
                      ...
                      <li>
                          <p class="yellow">You have 0 notifications</p>
                      </li>
                     <!-- <li>
                          <a href="#">
                      ...
                      <li>
                          <a href="#">Afficher toutes vos notifications</a>
                      </li>
                  </ul>
              </li>
      ...
      <!--<footer class="site-footer">
        <div class="text-center"><?php echo date('Y'); ?> &copy; EiC Corporation.<a href="#" class="go-top"><i class="icon-angle-up"></i></a></div>
      </footer>-->
      <!--footer end-->
  </section>
